" Name:         nope-y
" Description:  nope with yellowish tint.
...
hi Normal guifg=#000000 guibg=#e4e4e0 gui=NONE cterm=NONE
hi Statusline guifg=#ffffff guibg=#626262 gui=bold cterm=bold
hi StatuslineNC guifg=#e4e4e0 guibg=#949494 gui=NONE cterm=NONE
hi VertSplit guifg=#949494 guibg=#949494 gui=NONE cterm=NONE
hi TabLine guifg=#e4e4e0 guibg=#949494 gui=NONE cterm=NONE
hi TabLineFill guifg=#e4e4e0 guibg=#949494 gui=NONE cterm=NONE
hi TabLineSel guifg=#626262 guibg=#ffffff gui=bold,reverse cterm=bold,reverse
hi ToolbarLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi ToolbarButton guifg=#e4e4e0 guibg=#626262 gui=NONE cterm=NONE
hi QuickFixLine guifg=#e4e4e0 guibg=#d700d7 gui=NONE cterm=NONE
hi CursorLineNr guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
hi LineNr guifg=#b2b2ac guibg=NONE gui=NONE cterm=NONE
hi NonText guifg=#b2b2ac guibg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=#b2b2ac guibg=NONE gui=NONE cterm=NONE
hi SpecialKey guifg=#b2b2ac guibg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#b2b2ac guibg=NONE gui=NONE cterm=NONE
hi Pmenu guifg=NONE guibg=#d0d0c9 gui=NONE cterm=NONE
hi PmenuSel guifg=NONE guibg=#b2b2ac gui=NONE cterm=NONE
...
hi PmenuKindSel guifg=#d7005f guibg=#b2b2ac gui=NONE cterm=NONE
hi PmenuExtra guifg=#8a8a8a guibg=#d0d0c9 gui=NONE cterm=NONE
hi PmenuExtraSel guifg=#8a8a8a guibg=#b2b2ac gui=NONE cterm=NONE
hi PmenuMatch guifg=#af00af guibg=#d0d0c9 gui=NONE cterm=NONE
hi PmenuMatchSel guifg=#af00af guibg=#b2b2ac gui=NONE cterm=NONE
...
hi VisualNOS guifg=#e4e4e0 guibg=#8a8a8a gui=NONE cterm=NONE
...
hi SpellCap guifg=NONE guibg=NONE guisp=#c56a4a gui=undercurl ctermfg=NONE ctermbg=NONE cterm=NONE
...
hi Conceal guifg=#b2b2ac guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi TabLineFill ctermfg=254 ctermbg=246 cterm=NONE
  hi TabLineSel ctermfg=241 ctermbg=231 cterm=bold,reverse
  ...
  hi PmenuExtra ctermfg=245 ctermbg=255 cterm=NONE
  hi PmenuExtraSel ctermfg=245 ctermbg=252 cterm=NONE
  hi PmenuMatch ctermfg=127 ctermbg=255 cterm=NONE
  hi PmenuMatchSel ctermfg=127 ctermbg=252 cterm=NONE
  ...
  hi DiffText ctermfg=96 ctermbg=254 cterm=reverse
...
if s:t_Co >= 16
  ...
  hi DiffText ctermfg=magenta ctermbg=white cterm=reverse
...
" Color: colorBg                 #e4e4e0        254            white
...
" Color: colorLine               #d9d9d2        231            grey
" Color: colorPmenu              #d0d0c9        255            grey
" Color: colorPmenuSel           #b2b2ac        252            grey
" Color: colorB                  #edede5        255            grey
" Color: colorNonT               #b2b2ac        248            grey
...
" Color: colorStIn               #949494        246            grey
